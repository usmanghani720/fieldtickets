...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'control-field' do |ba|
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'control-field-offset control-field' do |wr|
  ...
  config.wrappers :bootstrap_radio_buttons, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'control-field btn-group', html: {data: { toggle: 'buttons' } } do |ba|
      ba.use :input
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
