    ...
    wrappers: {
      "default": {
        add: function(element, settings, message) {
          ...
          wrapper = element.closest(settings.wrapper_tag + "." + (settings.wrapper_class.replace(/\ /g, '.')) + ' div');
        ...
        remove: function(element, settings) {
          var errorElement, wrapper;
          wrapper = element.closest(settings.wrapper_tag + "." + (settings.wrapper_class.replace(/\ /g, '.')) + ' div' + "." + settings.wrapper_error_class);
          errorElement = wrapper.find(settings.error_tag + "." + settings.error_class);
...
(function() {
  $(function() {
    $('form :input').on('input', function() {
      return $("#autoshow-form-buttons").fadeIn();
    });
    ...
    return $('#undo-my-changes').click(function() {
      $('form')[0].reset();
      $('#autoshow-form-buttons').fadeOut();
      return $('form input')[0].dispatchEvent(new Event('change'));
    });
  });
...
(function() {
  $(function() {
    return $('#reset_signature_canvas').click(function() {
      var hasSignature;
      hasSignature = false;
      input.value = '';
